    ...
    public class ProjectileCharacter : Character
    {
        ...
        public void UpdateWeapon()
        {
           ...
           // Console.WriteLine(orbiterRotation);
            ...
            if (cooldownTimer >= 1f && (Keyboard.GetState().IsKeyDown(Keys.Space) || InputManager.Pressed(Buttons.RightTrigger)))
            {
                Shoot();
                cooldownTimer = 0;
            }
        ...
        public virtual void Shoot()
        {
            ...
            projectile.SetPosition((Position - (new Vector2(-currentAnimation.FrameSize.X*2, -currentAnimation.FrameSize.Y*3))) + projectile.velocity);
